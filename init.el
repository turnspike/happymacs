...
(add-to-list 'load-path "~/.happymacs/local-packages")
...
(setq backup-directory-alist '(("." . "~/.happymacs/tmp/backups")))
(setq delete-old-versions -1)
(setq version-control t)
(setq vc-make-backup-files t)
(setq auto-save-file-name-transforms '((".*" "~/.happymacs/tmp/auto-save-list/" t)))

;; -- sessions
(setq desktop-dirname		  "~/.happymacs/tmp/"
...
;; --- Navigation ---
;;
(load-file "~/.happymacs/navigation.el")
(message "#happymacs: navigation config complete.")

;; -- Minibuffer
;;

(setq savehist-file "~/.happymacs/tmp/mb-history") ; save history to this location
...
;; --- Modeline
(load-file "~/.happymacs/modeline.el")
